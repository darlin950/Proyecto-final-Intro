document.addEventListener('DOMContentLoaded', function() {
    ...
    const routes = {
      rates: {
        car: { base: 100, perKm: 15, toll: 100 },
        bus: { base: 50, perKm: 8, toll: 200 },
        truck: { base: 200, perKm: 25, toll: 400 }
      },
      emissions: {
        car: 0.12,    // kg CO2 por km
        bus: 0.05,    // kg CO2 por km
        truck: 0.20   // kg CO2 por km
      }
    };
    ...
    function calculateTime(distance, transportType) {
      const speeds = { car: 75, bus: 65, truck: 70 }; // km/h
